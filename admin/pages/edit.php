...
$c_element = AB::QueryONE("SELECT stati.ID,stati.ACTIVATED, stati.NAME, stati.CODE, stati.SORT, stati.CATEGORY,
    ...
    <div class="tab-content" style="text-align: center">
        <div id="tab1" class="tab active">
            <form id="stati_main">
                ...
                <p>Категоря : <br><input name="CATEGORY" value="<?=$c_element["CATEGORY"]?>"/><br></p>
...
<button id="delete" attr-id="<?=$c_element["ID"]?>" style="background: red">Удалить</button>

<script>
    function test($s) {
        $.ajax({
            url: '/admin/pages/ajax.php',
            type: "POST",
            data: {
                action: $s,
    ...
    $('#delete').click(function () {
        window.location.href = '/admin/pages/ajax.php?action=delete&id='+$(this).attr('attr-id');
    });
</script>
